...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8382290189:AAER22W0VA1KmWCtbEujLBM7wlnqJMRFAYA")
    ...
    GROUPS = os.environ.get('GROUPS', '-1003651358527').split(',')
    for i in range(len(GROUPS)):
        GROUPS[i] = int(GROUPS[i])

    LOG_CH = os.environ.get("LOG_CH", "-1003651358527")
